...
namespace termProject
{
	...
	/// </summary>
	public class SemiRoundedButton : Button
	{
		...
		private GraphicsPath GetFigurePath(Rectangle rect, float radius)
		{
			...
			path.StartFigure();
			path.AddArc(rect.X, rect.Y, 1, 1, 180, 90);
			path.AddArc(rect.Right - curveSize, rect.Y, curveSize, 1, 270, 90);
